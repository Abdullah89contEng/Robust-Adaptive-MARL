...
summary_path, out_dir = '/home/abodeh/thesis/runs/eval_bruno_20260914/summary.csv', '/home/abodeh/thesis'
...
fig.tight_layout()
fig.savefig(f"{out_dir}/bruno-eval-detection.pdf", bbox_inches="tight")
print("wrote bruno-eval-detection.pdf")
...
fig.tight_layout()
fig.savefig(f"{out_dir}/bruno-eval-return.pdf", bbox_inches="tight")
print("wrote bruno-eval-return.pdf")
for r in rows:
